 ...
 * i) AddFromDialPad which allows the user to add a new contact from 
 * 		a text input.
 * ii) AddFromText which allows the user to click on a text to add 
 * 		a new contact with the name as the contents of the text and
 * 		the number as the number which sent the text
 * iii) ViewRecentContacts which allows the user to view their contacts
 * 		in most recently added order and click them to open the android
 * 		contacts page 
 * 
 * @author Matthew
 */
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    /**
     * The only option on the menu is to launch the set name activity.
     */
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem setName = menu.getItem(0);
    	setName.setOnMenuItemClickListener(new OnMenuItemClickListener(){
			@Override
			public boolean onMenuItemClick(MenuItem item) {
				Intent i = new Intent();
				i.setClass(MainActivity.this, SetName.class);
